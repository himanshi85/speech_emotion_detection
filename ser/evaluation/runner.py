...
def evaluate_split(
    ...
    report = sklearn_classification_report_dict(y_true, y_pred, CLASS_NAMES)
...
def save_split_results(
    ...
    save_predictions_csv(split_dir / "predictions.csv", meta, y_true, y_pred, confidences)
    save_classification_report_csv(split_dir / "classification_report.csv", report)
    save_confusion_matrix_csv(split_dir / "confusion_matrix.csv", cm)
    save_confusion_matrix_png(
